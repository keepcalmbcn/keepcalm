...
- [Organiser One-Pager](organiser-one-pager.md) - what the organiser role actually involves
...
Anyone can suggest a plan. Just post something like *"I'm going to X, who wants to join?"* and see who's in. If it's a bigger event, an admin will help organise it properly.
...
- **Casual invites** ("Who wants to grab dinner Saturday?") are always welcome
- **External event links, flyers, or Meetup links** need admin approval first
- **Paid events** (festivals, experiences, etc.) - suggest it casually and an admin will create an official post if there's interest
- No promoting other communities or groups

## Related Communities

We sometimes collaborate with other Barcelona communities:
- https://www.meetup.com/barcelona-english-speakers-meetup/
- https://www.meetup.com/barcelona-english-speakers/

## Getting Started

1. Join the Social WhatsApp group (links at https://keepcalm.fit/)
2. Introduce yourself
3. Jump into plans that interest you, or suggest your own!

## Questions?

- Post in the Social WhatsApp group
- Message an admin if you're unsure about posting something
