**Archived: Edition #1 post-event thank you (June 2026, Uno Pádel Teixonera).** Superseded by the standardized template as of Edition #2 (31 July 2026) - see [`finish-post.md`](finish-post.md). Kept for reference only, not for reuse as-is (named helpers and links specific to that event).
