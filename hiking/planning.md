...
A step-by-step reference for organising a Keep Calm hike from scratch.
...
Before committing to a route and date, confirm train logistics are viable.
...
Once date, route, and logistics are confirmed:
...
- Use previous hike docs as a template (see [hike-3/event-info.md](hike-3/event-info.md))
...
See [hike-3/whatsapp-post.md](hike-3/whatsapp-post.md) for an example post.

---

## 8. Set Up the Attendees WhatsApp Group

Once sign-ups close:
- Create a WhatsApp group for confirmed attendees
- Add all participants plus co-organisers
- Pin the event info or share a link to the event doc
- This is the channel for all day-before and morning-of updates

---

## 9. Send the Event Email

Send a detailed email to all registered participants a few days before the hike covering:
- Meeting point and time
- Train details
- What to bring
- Weather update (or note that one is coming)
- WhatsApp group link
- Organiser names

See [hike-3/event-email.md](hike-3/event-email.md) for a template.
