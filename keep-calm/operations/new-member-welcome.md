...
You've just joined Barcelona's community for English speakers who want to stay active and make friends. Here's everything you need to get started.
...
- All skill levels welcome (including complete beginners)
- A friendly, inclusive atmosphere
- A way to meet people and make real friends
...
Each sport posts a weekly poll asking who can make the next session. When you see it:
- Vote for the time slots that work for you
- Only vote if you genuinely plan to come
- Voting = committing to show up

### Step 3: Check the Games Post

After the poll closes, organisers will post who's playing when. Look for:
- Your name and assigned time/court
- Whether you're the "booker" (you'll book the court) or a player (you'll join someone else's booking)
...
### 🎾 Padel (Sundays)
- **When**: Sunday mornings and afternoons
- **Cost**: €5-8 per person
- **Level**: All levels (Beginner to Advanced)
- **Venues**: Multiple courts around Barcelona
- **How it works**: Vote in Saturday's poll → get assigned to a court → book or join → play!

### 🏐 Volleyball (Saturdays + ad-hoc)
- **When**: Saturdays 16:00-19:00, plus spontaneous sessions
- **Cost**: Free (beach)
- **Level**: All levels
- **Location**: Beach (Nova Icaria, Bogatell, etc.)
- **How it works**: Watch for announcements → show up → rotate in
...
- **Cost**: Free
- **Level**: All levels
- **Location**: Sants outdoor tables
- **How it works**: Vote for arrival time → show up → play

### 🥾 Hiking (Monthly)
- **When**: Usually one Sunday per month
- **Cost**: Train fare (€3-7 each way)
- **Level**: Moderate fitness
- **How it works**: Watch for event announcements → sign up → join the group

### 🍻 Social Events
- **When**: Varies (post-game drinks, seasonal parties)
- **Cost**: Varies
- **How it works**: Watch for announcements → RSVP → come hang out

---

## Complete Beginner?

**That's totally fine!** We run beginner sessions for most sports and everyone was new once.
...
- Help find a replacement if you need to cancel

### Be Respectful
- Welcome others, especially newcomers
- Keep WhatsApp on-topic and positive
...
### Before
- Check the weather (especially for outdoor sports)
- Bring water and appropriate clothing
- Know where you're going (save the venue address)
- Have the booker's contact if needed
...
Sports are the excuse. Friendships are the point.
...
After a few sessions, if you enjoy the community:

### Small Ways to Help
- Bring an extra ball or piece of equipment
- Welcome new people (you know how it feels now!)
- Take a photo and share with organisers
- Respond helpfully in WhatsApp

### Bigger Ways to Help
- Become a Booker (coordinate one court)
- Become a Beginner Ambassador (welcome newcomers)
- Help run sessions
...
*For organisers to send to new members:*

```
Hey [Name], welcome to Keep Calm [Sport]! 🎉

Here's how to get started:

1️⃣ Watch for the poll on [day] for upcoming sessions
2️⃣ Vote if you can make it (voting = committing to come)
3️⃣ Check the games post on [day] to see your assignment
4️⃣ Show up and have fun!
...
Barcelona can be a hard city to break into socially, especially as an expat or newcomer. Keep Calm exists because someone thought "there should be an easy way for English speakers to play sports and meet people." And now there is.

Show up. Be friendly. Give it a few tries. The friends you make here might be the highlight of your time in Barcelona.
