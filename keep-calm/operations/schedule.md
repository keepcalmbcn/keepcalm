# Keep Calm Weekly Schedule 📅

Quick reference for all our regular activities. All events are posted in their respective WhatsApp groups (find links at https://keepcalm.fit/).

## Weekly Events

### Thursday - Ping Pong 🏓
- **Time**: 18:00 - 21:00 (approx 2-3 hours)
- **Location**: Sants public tables - [Google Maps](https://maps.app.goo.gl/Y7rTeKDC61sYLTvh9)
...
### Saturday - Padel Poll Opens 🎾
- **Time**: Saturday morning
- **Action**: Poll posted for NEXT Sunday's games (one week ahead)
- **Poll closes**: Tuesday evening
...
### Sunday - Hiking (Monthly) 🥾
- **Frequency**: Approximately once per month
- **Time**: Usually full day trips (check event details)
- **Meeting point**: Varies by hike
...
### Volleyball 🏐
- **Frequency**: Organized throughout the week as members propose
- **Common times**: Saturday 16:00-19:00, but varies
- **Locations**: Public beach nets
  - Nova Icaria
  - Somorrostro
  - Bogatell
  - Barceloneta
...
1. **Join WhatsApp groups** for your sports at https://keepcalm.fit/
2. **Check announcements** posted in each group
3. **Vote in polls** when posted to secure your spot
4. **Follow event-specific instructions** shared by organizers
...
**Questions?** Ask in the relevant WhatsApp group or check the sport-specific README files.
