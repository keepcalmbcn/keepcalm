# Keep Calm Core - Welcome Message

The message we post in the **Keep Calm Core** group when new members join, to welcome them and invite them to introduce themselves. (For the direct message we send to *invite* someone to Core, see [invite.md](invite.md).)
...
💼 What you do (or happily don't do!)
...
- Keep it warm and low-pressure. The goal is real introductions, not a form to fill in.
- The fields mirror what Core members naturally shared in their own intros: name, origin, time in Barcelona, what they do, which Keep Calm activities they enjoy, and a fun fact.
- Pair it with a real in-person meetup whenever possible. People introduce themselves more happily when there's a face-to-face on the horizon.

## Related documents

- [Keep Calm Core](README.md) - What Core is and how someone becomes Core
- [Core Invitation](invite.md) - The direct message we send to invite someone to Core
