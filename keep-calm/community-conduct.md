...
1. Ask an organiser first
2. Explain what it is and why it might be useful
...
1. Send a private message explaining the policy
2. If it's a first offense, assume they didn't know
3. If repeated, treat as a strike offense
...
For the full photography and data policy, see [data-privacy.md](data-privacy.md).
