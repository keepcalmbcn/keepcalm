...
**Friday evenings**, normally at **La Mar Bella Municipal Sports Complex**, Av. del Litoral, 86-96, Poblenou - exact time confirmed weekly when courts are booked. The session ran 16:00-18:30 through June; since July it's consistently been later, typically **18:00-20:00** (confirmed 24 Jul, 31 Jul, and 7 Aug). See [Venue](friday-badminton-venues.md) for full details and how to get there, including the temporary Vall d'Hebron venue while La Mar Bella is closed for August.
...
Aim to arrive a few minutes before the confirmed start time (shared in the group that week) so you're warmed up and ready when court time starts.

### Where exactly are the courts?
Court numbers vary week to week depending on what Mel books - check the group for that week's exact courts and directions. See [Venue](friday-badminton-venues.md).
