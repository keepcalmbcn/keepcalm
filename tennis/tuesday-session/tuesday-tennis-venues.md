# Tuesday Tennis - Venues

We rotate venues depending on court availability and group size. Below are the venues we have used or considered.

---

## Primary Venue: Barcelona Pro Tennis Academy (Up Cornellà)

This is our main home base for Tuesday Tennis.
...
- **Cost (doubles, 4 players)**:
  ...
  - Clay court 90 min: ~€39 total → ~€10 per person
- **Cancellation**: Cancel for €0.50 fee up until 10:00 on the day of the match - very fair policy
- **Facilities**: Many courts (numbered), bar/restaurant nearby, grandstand on centre court, map/layout near the entrance fence
- **Travel**:
  - From Plaça Catalunya/Espanya: Take **L3** to Espanya, then **L8, S8, or R5** to Cornellà-Riera
  - Total journey from city centre: ~40 minutes
  - Nicer than the metro - seated train journey, less crowded
- **Court booking tip**: Book adjacent clay courts (e.g., Batida 6, 8, 10, 12) so all groups play near each other. When courts at 19:30 are gone, 20:30 almost always has availability.

**Why we use it**: Longest booking window of any venue we've found (7 days), Playtomic integration, good facilities, clay courts, reasonable prices for 90 minutes.

---

## Eurofitness Vall d'Hebron

A closer option in the city but harder to book.
...
- **Travel**: Take **L3** (green line) - very easy from the city centre
- **Notes**: The venue is a maze - use the Playtomic app to check which court number you're on. Courts are near the restaurant/reception area.

**Watch out for**: Slots disappear very fast. Evening slots are extremely popular - you need to be ready to book the moment the window opens. Non-members can only book 24h before.

---

## C.E.M. Tennis L'Hospitalet

Used in October 2025 - decent venue, accessible from the city.
...
## CET10 Olimpia (City Centre Option)

Popular with members for informal sessions - not typically used for the organised Tuesday group but commonly used for self-organised games.

- **Location**: City centre, near Poblenou - accessible from multiple lines
...
Used occasionally for Tuesday sessions when Up Cornellà is unavailable, and popular for self-organised games.

- **Address**: Montjuïc area, Barcelona - central and accessible
...
## Other Venues Members Have Mentioned

| Venue | Notes |
|-------|-------|
| Reial Societat de Tennis Pompeia | Mentioned as an option - requires membership invitation for guests (expensive) |
| Vall Parc | Bookable ~6 days in advance, reasonable prices, but limited availability |

---

## Venue Summary

| Venue | Booking Window | On Playtomic | Distance from Centre | Preferred Session |
|-------|---------------|-------------|---------------------|-------------------|
