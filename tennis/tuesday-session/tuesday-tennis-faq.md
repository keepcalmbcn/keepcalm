...
Cost is split equally between 4 players per court and paid through Playtomic.
...
Yes! The more the merrier. If you want to bring someone, just mention it in the group and they can join your court. They'll need a Playtomic account to pay their share.
...
### Do I need a Playtomic account?
Yes. Our primary venue (Up Cornellà) uses Playtomic for all bookings. It's free to create an account.

**How to set up Playtomic:**
1. Download the app: [app.playtomic.com](https://app.playtomic.com/)
2. Sign up with email or social media
3. Add your name and a profile photo (helps the booker identify you)

### How does the booking work?
One person (the **booker**) books the court on Playtomic and shares the link in the WhatsApp group. Everyone else clicks the link and joins.

**How to join a shared Playtomic court:**
1. The booker posts a link like `https://app.playtomic.io/t/XXXXX`
2. Tap the link (or open it in the Playtomic app)
3. Join the match and pay your share

**How to share a court if you're the booker:**
1. Book the court on Playtomic
...
Bring your own if you have one. Rental rackets may be available at the venue but it's not guaranteed — always check in the group if you need to borrow one. Regular players sometimes have a spare.

### What about tennis balls?
**Important: do not use padel balls for tennis!** They're a different size and weight — trust us, we learned this the hard way. Coordinate ball supply in the group chat before the session. One or two cans is enough for a 90-minute doubles game.

### Do I need specific shoes?
Sports shoes are fine and no venue has been strict about this. Court shoes (tennis shoes) are better on clay to avoid slipping, but most players manage without them.

### What should I wear?
Any comfortable sports clothes. Clay courts can leave orange dust on shoes and clothes — worth knowing before you turn up in white.
...
Indoor/covered courts are available at Up Cornellà (the quick courts are covered). Clay courts at Up are outdoor — if rain is expected, the booker may opt for the quick court instead.

Games are on unless officially cancelled by an organiser. Don't assume cancellation based on the weather forecast — wait for official word in the group.

### What if I can't make it after voting?
Let the group know **as early as possible** — give at least 5 days notice if you can. You're part of a 4-person court, so your absence affects 3 other people. Try to find a replacement rather than just announcing you're out.

See [Group Rules](../rules.md) for the full cancellation policy.

---

## Other Sessions & Social Play

### Can I organise a game at a different time or venue?
